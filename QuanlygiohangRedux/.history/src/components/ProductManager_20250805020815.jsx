...
export default function ProductManager() {
  ...
  const handleChange = (e) => {
    ...
    setForm((f) => ({ ...f, [name]: value })); // f: form
    // setForm((f) => ...) tránh bug do closure nếu có nhiều sự kiện
    // [name]: đây là attr name trong input
  };
  ...
  const handleSubmit = (e) => {
    ...
    if (form.id) {
      ...
      // dispatch(updateProduct({ ...form, name, price })); ok nhưng thừa
      ...
      // trong slice có tạo id rồi k cần truyên hẳn form
    }
